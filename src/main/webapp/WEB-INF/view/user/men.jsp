...
<div class="header2 text-center">
	 <div class="container">
		...
		<ul class="megamenu skyblue">
			...
			<li class="active"><a href="men.jsp">鞋履</a></li>
		 ...
		 <div class="col-md-9 product-model-sec">
					 <a href="single.jsp"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>MALONE SOULIERS</h4>
								<span class="item_price">$607</span>
					 ...
					 <a href="single.jsp"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>GUCCI</h4>
								<span class="item_price">$698</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">	
							</div>										
							<div class="clearfix"> </div>
					...
					<a href="single.jsp"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>BALENCIAGA</h4>
								<span class="item_price">$1555</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">	
							</div>											
							<div class="clearfix"> </div>
					...
					<a href="single.jsp"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>THE ROW</h4>
								<span class="item_price">$2420</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">
							</div>												
							<div class="clearfix"> </div>
					...
					<a href="single.jsp"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>JIMMY CHOO</h4>
								<span class="item_price">$1199</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">
							</div>												
							<div class="clearfix"> </div>
					...
					<a href="single.jsp"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4 class="love-info">GIANVITO ROSSI</h4>
								<span class="item_price">$1006</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">	
							</div>										
							<div class="clearfix"> </div>
